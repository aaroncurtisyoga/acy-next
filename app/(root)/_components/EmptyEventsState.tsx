...
const EmptyEventsState: FC<EmptyEventsStateProps> = ({ hasFiltersApplied }) => {
  return (
    <Card className="flex-1 border border-gray-200 shadow-none rounded-2xl transition-all duration-300 @container">
      <CardContent className="flex flex-col items-center justify-center text-center py-16 px-6 @sm:py-20 @sm:px-8">
        <h3 className="text-xl @sm:text-2xl font-bold text-gray-900 mb-3 tracking-tight">
          No Events Found
        </h3>
        <p className="text-gray-700 text-base @sm:text-lg leading-relaxed font-medium @sm:px-10">
          {hasFiltersApplied
