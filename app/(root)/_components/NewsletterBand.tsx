...
export default function NewsletterBand() {
  return (
    <section
      ...
      className="scroll-mt-20 border-t border-[#dee3f2] bg-band py-14 dark:border-navy-card dark:bg-[#161c2c] md:py-20"
    >
      <div className="mx-auto w-full max-w-screen-2xl px-4 md:px-6 lg:px-12">
        ...
        <p className="mt-3 max-w-[52ch] text-base font-medium text-[#3c3f4c] dark:text-white/70 md:text-[17px]">
